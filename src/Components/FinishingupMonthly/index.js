...
function Finish(props) {
 ...
 <p className="main-p">Double-check everything looks OK before confirming.</p>
  <div className="map-div">
  <div className="finishplan">
  <span className="finish-miniheader">Arcade({props.miniheaderprop})</span>
  ...
  <p className="finish-sum">{props.sum}</p>
   ...
   <Button back={<Link to='/addonsmonthly' style={{color:'hsl(231, 11%, 63%)', textDecoration: 'none', backgroundColor: 'hsl(0, 0%, 100%)', fontWeight: '700', border: 'none'}}>Go Back</Link>}  next={<Link to='/thankyou' style={{color:'hsl(0, 0%, 100%)', textDecoration: 'none' }}>Confirm</Link>} styles={{marginTop: '20px'}} bgcolor={{backgroundColor: 'hsl(243, 100%, 62%)'}}/>
    </div>
  )
}
